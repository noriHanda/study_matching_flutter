...
class UserOffersSetBlocLoggedOut {
  UserOffersSetBlocLoggedOut() {
    fetchUserOffersSets();
  }
  ...
  Future<void> fetchUserOffersSets() async {
    final result =
        await offerApi.fetchUserOfferSetListLoggedOut(limit: 50, offset: 0);
  ...
  dispose() => _offerController.close();
}
