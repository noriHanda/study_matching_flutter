// Use this to allow access on profile page without login
...
class ProfileOfferListBlocLoggedOut {
  ...
  Future<void> fetchOffersLoggedOut(int userId) async {
    setOfferLoadingStatus.add(true);
    final result =
        await offerApi.fetchIndividualUserOfferListLoggedOut(userId: userId);
